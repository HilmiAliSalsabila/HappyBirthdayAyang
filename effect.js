...
$('document').ready(function () {
  ...
  $(window).resize(function () {
    ...
    $('#b100').animate({ top: 240, left: vw + 550 }, 500);
    $('#b111').animate({ top: 240, left: vw + 650 }, 500);
    $('#b112').animate({ top: 240, left: vw + 750 }, 500);
    $('#b113').animate({ top: 240, left: vw + 850 }, 500);
    $('#b114').animate({ top: 240, left: vw + 950 }, 500);
    $('#b115').animate({ top: 240, left: vw + 1050 }, 500);
    $('#b116').animate({ top: 240, left: vw + 1150 }, 500);
    $('#b117').animate({ top: 240, left: vw + 1250 }, 500);
  });
  ...
  $('#balloons_flying').click(function () {
    ...
    $('#b8,#b9,#b10,#b11').addClass('balloons-rotate-behaviour-one');
    $('#b12,#b13,#b16').addClass('balloons-rotate-behaviour-two');
    $('#b14,#15,#b17').addClass('balloons-rotate-behaviour-one');
    loopOne();
    loopTwo();
    loopThree();
    loopFour();
